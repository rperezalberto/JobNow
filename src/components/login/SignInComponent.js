      ...
      <View>
        ...
        <TouchableOpacity onPress={() => navigate('TabsNavigation')}>
          <View style={StyleLogin.btn}>
              <Text style={StyleLogin.btnTxt}>Sign Up</Text>
          </View>
        </TouchableOpacity>

      <View style={StyleLogin.containerTxtLogin}>  
          <View style={StyleLogin.txtDirection}>
            <Text style={{...StyleLogin.txt, color: colores.black}}>By signing up, you accept our </Text>
            <Text style={{...StyleLogin.txtLink, ...StyleLogin.txt, color: colores.blue}}>conditions</Text>
          </View>

          <View style={StyleLogin.txtDirection}>
            <Text style={{...StyleLogin.txt, color: colores.black}}>Have an account? </Text>
            <TouchableOpacity onPress={() => setIsEnabled(!true)}>
              <Text style={{...StyleLogin.txtLink, ...StyleLogin.txt}}>Login</Text>
            </TouchableOpacity>
          </View>
